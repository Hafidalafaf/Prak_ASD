print ("NAMA : Hafidz Al Afaf")
print ("NIM  : L200170134")
print ("KELAS: D")
print ("MODUL: 2")
...
class Manusia(object):
    ...
    def __init__(self, nama):
        self.nama = nama
    def ucapkanSalam(self):
        print("Salam, nama ane ",self.nama)
    def makan(self, s):
        print("Saya baru saja makan ", s)
        self.keadaan = 'kenyang'
    def olahraga(self, k):
...
class Mahasiswa(Manusia):
    ...
    def __init__(self, nama, NIM, kota, us):
        ...
        self.uangSaku = us
    def __str__(self):
        s = self.nama + ', NIM ' + str(self.NIM) \+ '. Tinggal di ' + self.kotaTinggal \+ ' tiap bulannya.'
        return s
    def ambilNama(self):
        return self.nama
    def ambilNIM(self):
